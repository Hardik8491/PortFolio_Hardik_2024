...
const ConstraintedBox = (props: Readonly<CoreComponentsProps>) => {
    ...
    return (
        <div
            className={`relative flex flex-col justify-start items-start w-full constrained-width p-0 mx-auto my-0 overflow-hidden transition duration-300 ease-in-out drop_in ${className}`}
            id={id}
            ref={elementRef}
            onClick={onClick}
        >
